function aster_segment, image,subtractbackground=subtractbackground, minimumsize=minimumsize, threshold=threshold, interactive = interactive, groupleader = groupleader, default = defaultmask, stack= stack, $
